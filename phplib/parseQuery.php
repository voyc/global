 ...
 *		A hypen in front of a word or phrase means this should be excluded.
 *		A spaces is always represented by a plus-sign +.
 *		Advanced queries will include keywords followed by a colon.
 *
 * @param $col string Columnname
 * @param $q string plain text query string
 *
 */
function parseQuery ($col, $q) {
